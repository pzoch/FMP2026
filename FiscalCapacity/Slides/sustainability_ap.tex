...
\hypersetup{pdftitle={Debt Sustainability II}}
% Enter link to PDF file with figures:


\begin{document}
% Enter presentation title:
\title{Debt Sustainability II}
...
\begin{frame}{Valuation approach}
    \begin{itemize}
        \item Today we will look at debt sustainability from a different perspective: asset pricing.
        \item Idea: use tools from asset pricing to value government debt.
    \end{itemize}
\end{frame}
...
\begin{frame}{Asset pricing basics}  
    \begin{itemize}
        \item Define $M_{t,t+1}\coloneq \beta \frac{u^\prime\of{c_{t+1}}}{u^\prime\of{c_t}}$; we call it the \alb{stochastic discount factor} (SDF).
    \item We can write the asset pricing equation for \al{each asset} as \begin{align*}
    1 = \E_t M_{t,t+1} R_{i,t,t+1}.
\end{align*}
\item The \alg{risk-free rate} is defined as $R^f_{t,t+1}$ that satisfies \begin{align*} 
...
\begin{frame}{Asset pricing basics}  
    \begin{itemize}
        \item Generally $\E_t M_{t,t+1} R_{i,t,t+1} \alr{\neq} \E_t M_{t,t+1} \cdot \E_t R_{i,t,t+1}$, and we have 
        \begin{align*}
...
\begin{frame}{Asset pricing basics}  
    \begin{itemize}
        \item Consider a basic example: let $u\of{c} = \ln c$. We have \begin{align*}
...
\begin{frame}{Fiscal capacity}  
    \begin{itemize}
        \item In the risk free world, the first term is the \al{only} one that matters.
        \item In the risk free world, fiscal capacity is determined \al{only} by the ability to generate current and future surpluses.
        \item The second and the third term reflect
        the \al{riskiness} of the surplus process.
        \item If taxes are \alg{high} when the SDF is low, the second term \al{lowers} the fiscal capacity.
        \item If government spending is \alr{low} when the SDF is low, the third term \al{lowers} the fiscal capacity.
...
\begin{frame}{Fiscal capacity}  
    \begin{itemize}
        ...
        \item GDP \al{growth} is risky, i.i.d. with a mean of $x$ and volatility of $\sigma$.
...
\begin{frame}{Fiscal capacity}  
    \begin{itemize}
        ...
        \end{align*}
        \item Notice no time subscripts: this is because of the i.i.d. on growth rates assumption + constant ratios $\tau,\gamma$.
     \end{itemize}
\end{frame}
...
\begin{frame}{Fiscal capacity}  
    \begin{itemize}
        ...
        \item The claim on the stream of surpluses is worth $10\cdot \frac{0.25-0.225}{0.015+0.03-0.02} = 10$ trillion.
        \item Fiscal capacity of this economy is 10 trillion. 
        \item It equals $100\%$ of (initial) GDP.
...
\begin{frame}{Fiscal capacity}  
    \begin{itemize}
        ...
        \item The government cost of funding $r_B$ can be written as \begin{align*}
            r_B = r_T \frac{P^T}{Y}\frac{Y}{B} - r_G \frac{P^G}{Y}\frac{Y}{B}.
        \end{align*}
...
\begin{frame}{Fiscal capacity}  
    \begin{itemize}
        \item In this example tax revenue and government purchases are proportional to GDP.
...
\begin{frame}{Fiscal capacity}  
    \begin{itemize}
    \item Go back to our example: $\beta_G = 1$, $P^G/Y = 90$, $B/Y=1$.
