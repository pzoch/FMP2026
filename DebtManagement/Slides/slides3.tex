...
\title{Wars, Debt, and Taxes in the U.S.}
...
\end{frame}
    ...
    \begin{frame}{Two theories}
    \begin{itemize}
        \item We will consider a simplified version of Lucas and Stokey (1983) -- we studied it in week 1
        \item In both theories the government sets taxes and issues debt to minimize deadweight loss of taxation
        \[
        \min[\bc{\tau_t}_{t=0}^\infty] \E[0] \sum_{t=0}^\infty \bs{\bp{\frac{1}{1+r}}^t D\bp{\tau_t}}
        \]
        \item We assume government expenditures $g_t$ are a function of a Markov state $s_t$, $g_t = G\bp{s_t}$. Let $$s_{t+1} \sim \phi\bp{s_{t+1}\mid s_t }$$ where 
        $ \phi\bp{s_{t+1}\mid s_t }$ is a Markov transition probability distribution defined on the time invariant
        state-space.
    \end{itemize}
    \end{frame}
    ...
    \item In the \alr{Lucas and Stokey (1983) case} the government can use \al{state-contingent debt}:
    \begin{align*}
...
\begin{frame}{Two theories}
    ...
    \begin{frame}{Government budget constraint}
        \begin{figure}
            \includegraphics[width=1\textwidth]{debt_owner.png}
            \caption{Debt ownership.} 
        \end{figure}
    \end{frame}

    \begin{frame}{Government budget constraint}
        \begin{figure}
            \includegraphics[width=1\textwidth]{debt_value.png}
            \caption{Debt value.} 
        \end{figure}
    \end{frame}
    ...
    \begin{frame}{Optimal response}
        ...
        \begin{frame}{Receipts and expenditures}
            \begin{figure}
                \includegraphics[width=1\textwidth]{receiptsexpenditures.png}
            \end{figure}
        \end{frame}
    ...
    \begin{frame}{Prices}
        \begin{figure}
            \includegraphics[width=0.9\textwidth]{prices1.png}
            \caption{Price level.} 
        \end{figure}
    \end{frame}
    ...
    \begin{frame}{Prices}
        \begin{figure}
            \includegraphics[width=0.9\textwidth]{prices2.png}
            \caption{Price level.} 
        \end{figure}
    \end{frame}
    ...
    \begin{frame}{Returns}
        \begin{figure}
            \includegraphics[width=0.9\textwidth]{portfolio1.png}
            \caption{Cumulative returns on debt portfolio.} 
        \end{figure}
    \end{frame}

    \begin{frame}{Returns}
        \begin{figure}
            \includegraphics[width=0.9\textwidth]{portfolio2.png}
            \caption{Cumulative returns on debt portfolio.} 
        \end{figure}
    \end{frame}
